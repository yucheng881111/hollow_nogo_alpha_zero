...
P1B='./hollow_nogo_alpha_zero --shell --name="new_Hollow-Black" --black="mcts N=5000"'
P1W='./hollow_nogo_alpha_zero --shell --name="new_Hollow-White" --white="mcts N=5000"'
# commands for local player 2
P2B='./nogo-judge --shell --name="Normal-Black" --black="weak"'
P2W='./nogo-judge --shell --name="Normal-White" --white="weak"'
# commands for local random player
#P2B='/home/yucheng/RL/hollow_nogo_MCTS/nogo --shell --name="Hollow-Black" --black="mcts N=5000"'
#P2W='/home/yucheng/RL/hollow_nogo_MCTS/nogo --shell --name="Hollow-White" --white="mcts N=5000"'
